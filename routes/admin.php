...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/landing-pages/delete-image/{id}', 'Backend\LandingPageController@deleteImage')->name('admin.landing-pages.delete-image');
    Route::post('/landing-pages/delete-review-image/{id}', 'Backend\LandingPageController@deleteReviewImage')->name('admin.landing-pages.delete-review-image');
