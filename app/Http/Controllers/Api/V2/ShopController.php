...
class ShopController extends Controller
{
    ...
    {
        return Cache::remember("app.shop_info_$id", 86400, function () use ($id) {
    ...
    {
        return Cache::remember("app.shop_of_user_$id", 86400, function () use ($id) {
    ...
    {
        return Cache::remember("app.shop_all_products_$id", 3600, function () use ($id) {
